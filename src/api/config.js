...
const URL = {
  ...
  // 首页轮播图分类
  // foodEntry: 'https://www.easy-mock.com/mock/5c9cad0707c0ba1a896adc85/elem/entries',   // 失效
  foodEntryPrefix: 'https://cube.elemecdn.com',
  foodEntry: 'https://www.fastmock.site/mock/a6c7dc1e83c50d77ba4c7c8b241c4e82/eleme/entries',
  // 获取首页轮播分类 id 集
...
const formatSwipeData = (data) => {
  ...
  tempArr[index].image_url = URL.foodEntryPrefix + item.image_url
    return item
  })
